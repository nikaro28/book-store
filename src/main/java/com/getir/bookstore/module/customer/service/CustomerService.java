...
public class CustomerService {
  ...
  public Result<Long> addCustomer(Customer customer) {
    Customer oldCustomer = customerRepo.findCustomerByEmail(customer.getEmail()).orElse(null);
    if (oldCustomer != null) {
      return Result.withError(HttpStatus.CONFLICT, "This email id is already in use!");
    }
